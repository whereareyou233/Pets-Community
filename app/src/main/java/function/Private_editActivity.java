...
import com.example.pats_community.LoginUser;
...
import util.CityBean;
import util.PhotoUtils;
import util.ProvinceBean;
import util.ToastUtils;
import widget.ItemGroup;
import widget.TitleLayout;

public class Private_editActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_private_edit);
        ...
        ri_portrati = (ImageView)findViewById(R.id.edit_headshot);
     ...
     //   ri_portrati.setImageBitmap(BitmapFactory.decodeResource(getResources(),R.mipmap.headshot));
        User user = DataSupport.findLast(User.class);
     //   ri_portrati.setBackgroundResource(user.getImageId());
        ...
        titleLayout.getTextView_forward().setOnClickListener(new View.OnClickListener() {
          ...
          //      loginUser.update();
                mToast.showShort(Private_editActivity.this,"保存成功");
                finish();
            }
        });
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.ig_gender:
                //性别选择器
                pvOptions = new OptionsPickerBuilder(Private_editActivity.this, new OnOptionsSelectListener() {
                    @Override
            ...
            case R.id.ig_brithday:
                ...
                //初始化picker并show
                TimePickerView pvTime = new TimePickerBuilder(Private_editActivity.this, new OnTimeSelectListener() {
                    @Override
            ...
            //点击修改名字的逻辑
            case R.id.ig_name:
                Intent intent  = new Intent(Private_editActivity.this, EditName.class);
    ...
    private void show_popup_windows(){
        ...
        take_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(popupWindow != null && popupWindow.isShowing()) {
                    imageUri = photoUtils.take_photo_util(Private_editActivity.this, "com.Pats_community.fileprovider", "output_image.jpg");
        ...
        from_albums.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //申请权限
                if(ContextCompat.checkSelfPermission(Private_editActivity.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(Private_editActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }else {
                    //打开相册
